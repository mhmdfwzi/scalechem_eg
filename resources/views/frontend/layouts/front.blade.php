...
<html class="no-js" lang="zxx">
    ...
    <meta property="og:url" content="https://scalechem-eg.com/en/@yield('Page-url')">
    ...
    <meta name="twitter:url" content="https://scalechem-eg.com/en/@yield('Page-url')"> 
    <!-- ========================= CSS here ========================= -->
            ...
            @endphp
                    ...
                    <div class="nav-social">
                        <ul>
                            ...
                            <li>
                                <a href="https://www.instagram.com/scale_pharmaceutical?igsh=ZmpjNHdwYTVnYWNw&utm_source=qr"><i class="lni lni-instagram"></i></a>
                            </li>
                           
                            <li>
                                <a href="tel:01005242818" target="_blank"><i class="lni lni-phone"></i></a>
                            </li>
